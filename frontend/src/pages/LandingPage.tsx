    ...
    <div style={{ minHeight: '100dvh', background: '#ffffff', fontFamily: "'Inter', sans-serif", overflowX: 'hidden' }}>
      ...
      <section style={{
        ...
        <div style={{ flex: '1 1 380px', position: 'relative', zIndex: 1, animation: 'lp-fadeInUp 0.55s ease both' }}>
          <h1 style={{
            ...
            Find Medicines,{' '}
            <span style={{ color: '#0284a8' }}>Near You</span>
            {' '}and In Stock.
          </h1>

          <p style={{ fontSize: 'clamp(14px, 1.8vw, 17px)', color: '#475569', lineHeight: 1.75, marginBottom: 28, maxWidth: 460 }}>
            MediFind connects patients with licensed pharmacies across Zimbabwe in real time —
            search stock, reserve your order, and collect without the wasted trip.
          </p>

          <div style={{ display: 'flex', gap: 20, flexWrap: 'wrap', marginBottom: 32 }}>
            {['Licensed Pharmacies Only', 'Real-time Stock', '10-min Reservation Hold'].map(label => (
      ...
      <section style={{
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 14, position: 'relative', zIndex: 1 }}>
          {['Real-time inventory management', 'Patient reservation system', 'Order pickup portal', 'Distance-based patient matching'].map(feat => (
      ...
      <footer style={{
        ...
        <span style={{ fontSize: 13, color: '#475569' }}>
          © {new Date().getFullYear()} MediFind Zimbabwe · Making healthcare accessible across Zimbabwe
        </span>
      </footer>
